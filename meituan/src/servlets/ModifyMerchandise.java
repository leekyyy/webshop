...
import service.ModifyMerchandiseService;
...
public class ModifyMerchandise extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String pid =p_id;
        System.out.println("AAA"+pname);
        System.out.println("BBB"+pprice);
        ModifyMerchandiseService mm = new ModifyMerchandiseService();
        int result = mm.ModifyMerchandise(pname, pprice, imgurl, pnum, pid);
        if(result == 1){
