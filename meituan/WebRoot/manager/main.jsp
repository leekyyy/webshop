<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="zhku.lyy.web_shop.entity.User"%>
<%@taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
<html>
<head>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<%-- <title>${sessionScope.user.name}的管理中心</title> --%>
<title>${user }的管理中心</title>
<!-- 给页面添加ico -->
...
--%>
<frameset rows="150,*" cols="*" frameborder="1" border="2"
	framespacing="5">
	<frame src="<%=request.getContextPath()%>/manager/top.jsp"
		name="topFrame" scrolling="no" noresize="noresize">

	<frameset rows="150" cols=200,*" frameborder="1" border="2">
